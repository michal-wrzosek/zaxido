...
export type ListingsQuery = { __typename?: 'Query', listings: Array<{ __typename?: 'Listing', id: string, title: string, subreddit: string, author: string, permalink: string, url: string, thumbnail?: string | null, ups: number, downs: number, numberOfComments: number }> };
